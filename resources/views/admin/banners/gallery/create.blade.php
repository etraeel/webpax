@component('admin.layouts.content' , ['title' => 'ایجاد بنر'])
    @slot('breadcrumb')
        ...
        <li class="breadcrumb-item"><a href="{{route('admin.admin')}}">ویرایش بنر ها</a></li>
        <li class="breadcrumb-item active">ثبت بنر</li>
    @endslot
                ...
                return `
                    <div class="row image-field" id="image-${id}">
                        ...
                        <div class="col-5">
                            <div class="form-group">
                                 <label>لینک </label>
                                 <input type="text" name="images[${id}][link]" class="form-control">
                            </div>
                        </div>
                         <div class="col-2">
                            <label >اقدامات</label>
